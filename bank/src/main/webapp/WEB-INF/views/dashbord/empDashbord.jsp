...
<body bgcolor="#9f9f9f">
   ...
   <h1>DashBord page</h1>
       ...
       <div class="container" >
       	    ...
       	    Integer balence=(Integer)request.getAttribute("ballence");
       	        
       	        %>
       	        <div align="right" >
                  <h1> <a style="color: pink">  total Ballence <br> <%= balence%> </a></h1>
                   </div>
			...
			<div class="center" style="bgcolor: green;">
				 ...
				 <a href="/v1/bank/emp/f_trans"> Fund Trasfer</a> <br> <br>
				 <a href="/v1/bank/emp/veiwStatment"> views Statments</a> <br>
			...
			<div class="center2">
			  <a><img alt="/police/mainpage.png" src="*mainpage.png"></a>
		 	  ...
		 	  <div class="center1">
					...
					<a href="/v1/bank/emp/reports"> views reports </a> <br>
					<ul>
